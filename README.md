...
### Download APK
You can download the latest **Debug** and **Release** APKs from the [GitHub Releases](https://github.com/hslcrb/Rivery_aIOStyleCamerApp/releases) page.

### Build from Source
```bash
git clone https://github.com/hslcrb/Rivery_aIOStyleCamerApp.git
cd Rivery_aIOStyleCamerApp
...
### APK 다운로드
최신 **Debug** 및 **Release** APK는 [GitHub Releases](https://github.com/hslcrb/Rivery_aIOStyleCamerApp/releases) 페이지에서 다운로드할 수 있습니다.
